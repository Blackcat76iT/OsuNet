...
namespace OsuNet {
    ...
    public class OsuApi : IOsuApi {
		...
		private Dictionary<string, string> BeatmapQuery(GetBeatmapOptions options) {
		...
		private Dictionary<string, string> UserQuery(GetUserOptions options) {
            return new Dictionary<string, string>() {
                { "k", AccessToken },
		...
		private Dictionary<string, string> UserRecentQuery(GetUserRecentOptions options) {
            return new Dictionary<string, string>() {
                { "k", AccessToken },
                { "u", options.User },
                { "m", ((int?)options.Mode)?.ToString() },
        ...
        private Dictionary<string, string> ScoresQuery(GetScoresOptions options) {
            return new Dictionary<string, string>() {
                { "k", AccessToken },
                { "b", options.BeatmapId?.ToString() },
                { "u", options.User },
        ...
        private Dictionary<string, string> MultiplayerQuery(GetMultiplayerOptions options) {
            return new Dictionary<string, string>() {
                { "k", AccessToken },
        ...
        private Dictionary<string, string> ReplayQuery(GetReplayOptions options) {
            return new Dictionary<string, string>() {
                { "k", AccessToken },
                { "b", options.BeatmapId.ToString() },
                { "u", options.User },
